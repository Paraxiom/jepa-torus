...
echo "============================================"
echo "  V6: Dual-Path (512D + Fourier Torus)"
echo "  Path 1: 512D prediction (accuracy)"
echo "  Path 2: Karmonic Fourier torus (topology)"
echo "  $(date)"
echo "============================================"

# Train V6
python -m src.train_v6 --config configs/toroidal_v6_dual.yaml 2>&1
...
# Evaluate
python -m src.eval \
    --checkpoint checkpoints/toroidal_v6_dual/best.pt \
    --linear-probe \
    --analysis \
    --output-dir results/toroidal_v6_dual 2>&1
