...
echo "============================================"
echo "  V8a: Detached Karmonic"
echo "  Encoder: FREE (p512 + std only)"
echo "  Torus: INDEPENDENT (karmonic + pred)"
echo "  $(date)"
echo "============================================"

python -m src.train_v8a --config configs/toroidal_v8a_detached.yaml 2>&1

echo ""
echo "============================================"
echo "  V8a training complete: $(date)"
echo "============================================"

python -m src.eval \
    --checkpoint checkpoints/toroidal_v8a_detached/best.pt \
    --linear-probe \
    --analysis \
    --output-dir results/toroidal_v8a_detached 2>&1

echo ""
echo "============================================"
echo "  V8a COMPLETE: $(date)"
echo "============================================"
