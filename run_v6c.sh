...
echo "============================================"
echo "  V6c: Dual-Path (minimal torus weights)"
echo "  lambda_karmonic=0.1, lambda_std=5.0"
echo "  $(date)"
echo "============================================"

python -m src.train_v6 --config configs/toroidal_v6c_minimal.yaml 2>&1

echo ""
echo "============================================"
echo "  V6c training complete: $(date)"
echo "============================================"

python -m src.eval \
    --checkpoint checkpoints/toroidal_v6c_minimal/best.pt \
    --linear-probe \
    --analysis \
    --output-dir results/toroidal_v6c_minimal 2>&1

echo ""
echo "============================================"
echo "  V6c COMPLETE: $(date)"
echo "============================================"
