...
echo "============================================"
echo "  V6b: Dual-Path (softer torus weights)"
echo "  lambda_karmonic=1.0, lambda_std=10.0"
echo "  $(date)"
echo "============================================"

python -m src.train_v6 --config configs/toroidal_v6b_soft.yaml 2>&1

echo ""
echo "============================================"
echo "  V6b training complete: $(date)"
echo "============================================"

python -m src.eval \
    --checkpoint checkpoints/toroidal_v6b_soft/best.pt \
    --linear-probe \
    --analysis \
    --output-dir results/toroidal_v6b_soft 2>&1

echo ""
echo "============================================"
echo "  V6b COMPLETE: $(date)"
echo "============================================"
