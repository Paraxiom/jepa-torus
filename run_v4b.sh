...
echo "============================================"
echo "  V4b: T^5 Bottleneck (10D torus)"
echo "  $(date)"
echo "============================================"

mkdir -p checkpoints/toroidal_v4b_T5 results/toroidal_v4b_T5

python -m src.train_v4b --config configs/toroidal_v4b_T5.yaml 2>&1

echo ""
echo "=== Evaluating V4b T5 $(date) ==="

python -m src.eval \
    --checkpoint checkpoints/toroidal_v4b_T5/best.pt \
    --linear-probe --analysis \
    --output-dir results/toroidal_v4b_T5 2>&1
