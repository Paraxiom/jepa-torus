...
echo "============================================"
echo "  V3 Curriculum Training"
echo "  $(date)"
echo "============================================"

# Train V3 (loads baseline_vicreg checkpoint, curriculum learning)
mkdir -p checkpoints/toroidal_v3_N12 results/toroidal_v3_N12

python -m src.train_v3 --config configs/toroidal_v3_N12.yaml 2>&1

echo ""
echo "=== Evaluating V3 N12 $(date) ==="

python -m src.eval \
    --checkpoint checkpoints/toroidal_v3_N12/best.pt \
    --linear-probe --analysis \
    --output-dir results/toroidal_v3_N12 2>&1
